...
if RUN_AS_TEST:
    import keloid_skin_FEM_weakly_nonlinear

    u_msr_dom_func_original = keloid_skin_FEM_weakly_nonlinear.out['u_msr_dom_func']

    u_msr_dom_vals = None
    x_msr_dom_vals = None

    ux_msr_pad_vals = keloid_skin_FEM_weakly_nonlinear.out['ux_msr_pad_left_vals']
    fx_msr_pad_vals = keloid_skin_FEM_weakly_nonlinear.out['fx_msr_pad_left_vals']

    V_generator = keloid_skin_FEM_weakly_nonlinear.out['Vector Function Space']
    dx_material_generator = keloid_skin_FEM_weakly_nonlinear.out['FEM domain']
    ...
    for std_f_i, val_f in enumerate(std_f):
        ...
        for time_step_ in time_steps:
            ...
            if PLOT_RESULTS:
                ...
                ax.set_xlabel('Pad displacement (mm)', fontsize=12)
                ax.set_ylabel('Pad reaction force (N)', fontsize=12)
