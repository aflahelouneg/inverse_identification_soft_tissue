...
Point(97) = {x1_pad_one, y1_pad_one, 0, lc3};
...
Point(102) = {x6_pad_one, y6_pad_one, 0, lc3};
Point(103) = {x7_pad_one, y7_pad_one, 0, lc};

// pad two
Point(104) = {x0_pad_two, y0_pad_two, 0, lc};
Point(105) = {x1_pad_two, y1_pad_two, 0, lc3};
...
Point(110) = {x6_pad_two, y6_pad_two, 0, lc3};
...
Point(112) = {x1_pad_one, H0*0.5 + H_msr,0 , lc3};
Point(113) = {x1_pad_two, H0*0.5 + H_msr,0 , lc3};
Point(114) = {x1_pad_one, H0*0.5 - H_msr,0 , lc3};
Point(115) = {x1_pad_two, H0*0.5 - H_msr,0 , lc3};
